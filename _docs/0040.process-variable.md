...
- from a BPMN model, where each process step can set variables using [declarative process variable expressions]({{ site.url }}{{ site.baseurl }}/docs/variable-expression/) defined in the Flow diagram, before and after the process step.
...
[See doc]({{ site.url }}{{ site.baseurl }}/docs/tasks/)
...
[See doc]({{ site.url }}{{ site.baseurl }}/docs/api/#flow_process_vars)

Process variables can be substituted into the definition string for Timers.  [See doc]({{ site.url }}{{ site.baseurl }}/docs/timer-events/)
